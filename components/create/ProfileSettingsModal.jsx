      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col md:flex-row h-[600px] max-h-[90vh]">
        ...
        <div className="flex-1 flex flex-col relative overflow-hidden bg-white">
          ...
          <div className="flex-1 overflow-y-auto p-8 pt-12">
            {message.text && (
              <div
                className={`p-4 mb-6 rounded-lg text-sm border flex items-start gap-3 animate-in slide-in-from-top-2 ${
                  message.type === "error"
                  ...
                  <div className="flex items-center gap-6 mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mb-3">
                        แนะนำขนาด 256x256 px ไฟล์ PNG, JPG
                      </p>
                      <button
                        type="button"
                        onClick={() => fileInputRef.current.click()}
                        className="text-sm text-blue-600 font-semibold hover:text-blue-700 border border-blue-200 hover:border-blue-300 px-4 py-1.5 rounded-lg transition-colors"
                      >
                        อัปโหลดรูป
                      </button>
                      <input
                ...
                <form onSubmit={handleChangeEmail} className="space-y-6">
                  <div>
                    ...
                    <p className="mt-2 text-xs text-gray-500">
                      อีเมลนี้จะถูกใช้เพื่อยืนยันตัวตนและการแจ้งเตือนต่างๆ
                      ในระบบ
                    </p>
                  </div>
