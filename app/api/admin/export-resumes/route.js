...
export async function GET() {
  try {
    ...
    // Create CSV Header
    let csvData = 'Resume ID,Title,Template,Status,Views,Downloads,Author Name,Author Email,Created At\n';
    ...
    return new Response(csvData, {
      ...
      headers: {
        ...
        'Content-Disposition': 'attachment; filename="smartpersona_resumes_export.csv"',
      },
    });
  } catch (error) {
