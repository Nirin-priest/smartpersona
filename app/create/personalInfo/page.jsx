...
export default function ResumeBuilder() {
  const { data, updateData, setInitialData, resumeId, setResumeId } =
    useResume();
  ...
  useEffect(() => {
    ...
    fetchResume();
  }, [resumeId, setInitialData, setResumeId]);
          ...
          <div className="space-y-6 h-[90vh] overflow-y-auto pr-2 custom-scrollbar">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateData("personal", "firstName", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("personal", "lastName", e.target.value)
                    }
                  />
                </div>
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm text-gray-500 file:mr-4 file:py-1 file:px-3 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 disabled:opacity-60"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("personal", "email", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("personal", "phone", e.target.value)
                    }
                  />
                </div>
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("personal", "address", e.target.value)
                    }
                  ></textarea>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("education", "degree", e.target.value)
                    }
                  />
                </div>
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("education", "institution", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("education", "gradYear", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("education", "gpa", e.target.value)
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("experience", "position", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("experience", "company", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    value={data.experience?.details || ""}
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("experience", "details", e.target.value)
                    }
                  ></textarea>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-10">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    บทสรุปตัวตน (Professional Summary)
                  </label>
                  <textarea
                    rows="3"
                    placeholder="เขียนสรุปเป้าหมายหรือความโดดเด่นของคุณ..."
                    value={data.summary?.details || ""}
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("summary", "details", e.target.value)
                    }
                  ></textarea>
                </div>
                <div>
                  ...
                  <textarea
                    rows="3"
                    placeholder="เช่น React, Tailwind CSS, English Communication..."
                    value={data.skills?.list || ""}
                    className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    onChange={(e) =>
                      updateData("skills", "list", e.target.value)
                    }
                  ></textarea>
                </div>
              </div>
